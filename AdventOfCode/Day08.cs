...
public class Day08 : BaseDay
{
    ...
    public void process() {
        ...
        // Console.WriteLine("Largest distance squared is " + pairwiseDistances[pairwiseDistanceIndices[^1]]);
    }
    ...
    public long Part2(){
        ...
        while(true) {
            ...
            if (listOfCliques[0].Count == numPoints) {
                Console.WriteLine("graph connected at edge number " + k2);
    ...
    public int customComparison2(int a, int b) {
        if (a == 0) {
            return -1;
        }
        if (b == 0) {
